          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input required name="name" type="text" placeholder="Ej: Juan Pérez" className="w-full p-3 border border-slate-200 rounded-lg focus:ring-2 focus:ring-emerald-500 outline-none transition" />
              </div>

              <div>
                <label className="block text-xs font-bold text-slate-700 mb-1">Email</label>
                <input required name="email" type="email" placeholder="juan@gmail.com" className="w-full p-3 border border-slate-200 rounded-lg focus:ring-2 focus:ring-emerald-500 outline-none transition" />
              </div>

              <div>
                <label className="block text-xs font-bold text-slate-700 mb-1">Teléfono / WhatsApp</label>
                <input required name="phone" type="tel" placeholder="+54 11 ..." className="w-full p-3 border border-slate-200 rounded-lg focus:ring-2 focus:ring-emerald-500 outline-none transition" />
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div className="w-2/3">
                   ...
                   <div className="w-full p-3 bg-slate-50 border border-slate-200 rounded-lg text-slate-600 font-bold">
