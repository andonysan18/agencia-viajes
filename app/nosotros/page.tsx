...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-slate-50 pt-19"> {/* pt-20 para que no choque con el navbar fijo */}
      ...
      <section className="relative h-[50vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto animate-fade-in-up">
          ...
          <h1 className="text-4xl md:text-6xl font-serif font-bold text-white mb-6 leading-tight">
            Tradición y Confianza <br/> <span className="text-emerald-400">Sin Fronteras</span>
          </h1>
          <p className="text-slate-200 text-lg md:text-xl max-w-2xl mx-auto font-light">
            Respaldados por la trayectoria de <strong>Peruvian Tours</strong> (Peruvian Reps S.A.), conectamos Argentina y el mundo con excelencia desde nuestra casa matriz en Buenos Aires.
          </p>
        </div>
      </section>
      ...
      {/* 5. UBICACIÓN Y CONTACTO (La Oficina) */}
      <section className="py-20 bg-slate-50 border-t border-slate-200">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-serif font-bold text-slate-900 mb-8">Nuestra Casa Matriz</h2>
          
          <div className="bg-white p-10 rounded-3xl shadow-xl inline-block w-full max-w-4xl relative overflow-hidden">
             {/* Decoración */}
             ...
             <div className="flex flex-col md:flex-row items-center justify-around gap-8">
              ...
              <div className="flex flex-col items-center flex-1">
                ...
                <p className="text-slate-500 text-sm mt-1">Atención Personalizada</p>
                <button className="mt-3 text-emerald-600 text-sm font-bold hover:underline">
  ...
  return (
    <div className="p-6 rounded-2xl bg-slate-50 hover:bg-white hover:shadow-xl transition-all duration-300 border border-slate-100 group">
      <div className="text-emerald-500 mb-4 transform group-hover:scale-110 transition-transform duration-300">
        {/* Clonamos el icono para poder pasarle tamaño y stroke si fuera necesario, o simplemente lo envolvemos */}
